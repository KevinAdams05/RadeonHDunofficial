	...
	switch (feature) {
		...
		*/
		...
		case B_PROPOSE_DISPLAY_MODE:
			// Also carries the multi-monitor settings tunnel Screen
			// preferences uses; without this hook it hides the "Combine
			// displays" menu entirely. See multimon_tunnel.h.
			return (void*)radeon_propose_display_mode;
