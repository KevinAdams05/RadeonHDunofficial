...
const struct supported_device {
	...
	// Process: 28 nm
	//  Kaveri DCE 8.1 — APU (uses UMA, no dedicated VRAM)
	{0x1304, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon HD Kaveri"},
	{0x1305, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon HD Kaveri"},
	{0x1306, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon HD Kaveri"},
	{0x1307, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon HD Kaveri"},
	{0x1308, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon HD Kaveri"},
	{0x1309, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon R7 Series"},
	{0x130a, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon R6 Series"},
	{0x130b, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon R4 Series"},
	{0x130c, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon R7 Series"},
	{0x130d, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon R6 Series"},
	{0x130e, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon R5 Series"},
	{0x130f, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon R7 Series"},
	{0x1310, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon HD Kaveri"},
	{0x1311, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon HD Kaveri"},
	{0x1312, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon HD Kaveri"},
	{0x1313, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon R7 Series"},
	{0x1314, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon HD Kaveri"},
	{0x1315, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon R5 Series"},
	{0x1316, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon R5 Series"},
	{0x1317, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon HD Kaveri"},
	{0x1318, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon R5 Series"},
	{0x131b, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon R5 Series"},
	{0x131c, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon R7 Series"},
	{0x131d, 8, 1, RADEON_KAVERI, CHIP_APU, "Radeon R6 Series"},
	//  Bonaire DCE 8.2
	...
	//  Kabini DCE 8.3 — APU (uses UMA, no dedicated VRAM)
#if 0
	// Not working: #10939
	{0x9830, 8, 3, RADEON_KABINI, CHIP_APU, "Radeon HD 8400"},
	{0x9831, 8, 3, RADEON_KABINI, CHIP_APU, "Radeon HD 8400"},
#endif
	{0x9832, 8, 3, RADEON_KABINI, CHIP_APU, "Radeon HD 8330"},
	{0x9833, 8, 3, RADEON_KABINI, CHIP_APU, "Radeon HD 8330"},
	{0x9834, 8, 3, RADEON_KABINI, CHIP_APU, "Radeon HD 8210"},
	{0x9835, 8, 3, RADEON_KABINI, CHIP_APU, "Radeon HD 8210"},
	{0x9836, 8, 3, RADEON_KABINI, CHIP_APU, "Radeon HD 8280"},
	{0x9837, 8, 3, RADEON_KABINI, CHIP_APU, "Radeon HD 8280"},
	{0x9838, 8, 3, RADEON_KABINI, CHIP_APU, "Radeon HD 8240"},
	{0x9839, 8, 3, RADEON_KABINI, CHIP_APU, "Radeon HD 8180"},
	{0x983a, 8, 3, RADEON_KABINI, CHIP_APU, "Radeon HD Kabini"},
	{0x983b, 8, 3, RADEON_KABINI, CHIP_APU, "Radeon HD Kabini"},
	{0x983c, 8, 3, RADEON_KABINI, CHIP_APU, "Radeon HD Kabini"},
	{0x983d, 8, 3, RADEON_KABINI, CHIP_APU, "Radeon HD 8250"},
	{0x983e, 8, 3, RADEON_KABINI, CHIP_APU, "Radeon HD Kabini"},
	{0x983f, 8, 3, RADEON_KABINI, CHIP_APU, "Radeon HD Kabini"},
	//  Mullins DCE 8.3 — APU (uses UMA, no dedicated VRAM)
	{0x9850, 8, 3, RADEON_MULLINS, CHIP_APU, "Radeon HD R3"},
	{0x9851, 8, 3, RADEON_MULLINS, CHIP_APU, "Radeon HD R2"},
	{0x9852, 8, 3, RADEON_MULLINS, CHIP_APU, "Radeon HD R2"},
	{0x9853, 8, 3, RADEON_MULLINS, CHIP_APU, "Radeon HD R2"},
	{0x9854, 8, 3, RADEON_MULLINS, CHIP_APU, "Radeon HD R2"},
	{0x9855, 8, 3, RADEON_MULLINS, CHIP_APU, "Radeon HD R3"},
	{0x9856, 8, 3, RADEON_MULLINS, CHIP_APU, "Radeon HD R2"},
	{0x9857, 8, 3, RADEON_MULLINS, CHIP_APU, "Radeon HD R2"},
	{0x9858, 8, 3, RADEON_MULLINS, CHIP_APU, "Radeon HD Mullins"},
	{0x9859, 8, 3, RADEON_MULLINS, CHIP_APU, "Radeon HD Mullins"},
	{0x985a, 8, 3, RADEON_MULLINS, CHIP_APU, "Radeon HD Mullins"},
	{0x985b, 8, 3, RADEON_MULLINS, CHIP_APU, "Radeon HD Mullins"},
	{0x985c, 8, 3, RADEON_MULLINS, CHIP_APU, "Radeon HD Mullins"},
	{0x985d, 8, 3, RADEON_MULLINS, CHIP_APU, "Radeon HD Mullins"},
	{0x985e, 8, 3, RADEON_MULLINS, CHIP_APU, "Radeon HD Mullins"},
	{0x985f, 8, 3, RADEON_MULLINS, CHIP_APU, "Radeon HD Mullins"},
	//  Hawaii DCE 8.5
	...
	for (; gPCI->get_nth_pci_info(index, &info) == B_OK; index++) {
		...
		for (uint32 i = 0; i < sizeof(kSupportedDevices)
			...
			if (info.device_id == kSupportedDevices[i].pciID) {
				...
				// See docs/dce-vs-dcn-driver-boundaries.md. (Raven is
				// listed as DCE 12 in kSupportedDevices, but its
				// display engine is DCN 1.0.)
